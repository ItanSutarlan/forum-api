...
describe('/authentications endpoint', () => {
  ...
  describe('when POST /authentications', () => {
    ...
    it('should response 201 and new authenticaion', async () => {
      // Arrange
      const requestPayload = {
        username: 'dicoding',
        password: 'secret',
  ...
  describe('when PUT /authentications', () => {
    it('should have status code 200 and new access token', async () => {
      // Arrange
      const server = await createServer(container);
      // add user
      await server.inject({
    ...
    it('should have status code 400 if refresh token not registered in database', async () => {
      // Arrange
      const server = await createServer(container);
    ...
    it('should have status code 400 if refresh token not valid', async () => {
      // Arrange
      const server = await createServer(container);
    ...
    it('should have status code 400 if refresh token not string', async () => {
      // Arrange
      const server = await createServer(container);
    ...
    it('should have status code 400 if payload not contain refresh token', async () => {
      // Arrange
      const server = await createServer(container);
  ...
  describe('when DELETE /authentications', () => {
    it('should have status code 200 if refresh token valid', async () => {
      // Arrange
